...
extern void update_for_dtb_wakeup_key(void);
...
int board_late_init(void)
{
	...
	update_for_dtb_wakeup_key();  //set bl30 preboot key list
	return 0;
}
...
int checkhw(char *name)
{
	...
	switch (ddr_size) {
		case 0x40000000UL:
			strcpy(dtb_name, "t6d_t950d5_t335-1g\0");
			break;
		case 0x60000000UL:
			strcpy(dtb_name, "t6d_t950d5_t335-1.5g\0");
			break;
		default:
			strcpy(dtb_name, "t6d_t950d5_t335\0");
			break;
	}
