...
ddr_set_ps0_only_t __ddr_setting[] __attribute__ ((section(".ddr_param"))) = {
#if S4_DDR3_8
	{
		...
		.cfg_board_common_setting.ddr_func = 0,  //DDR_FUNC_CONFIG_DFE_FUNCTION,
		...
		.cfg_board_common_setting.dram_cs0_size_MB = CONFIG_DDR0_SIZE_AUTO_SIZE,//CONFIG_DDR0_SIZE_2048MB,                     //CONFIG_DDR0_SIZE_AUTO_SIZE,CONFIG_DDR0_SIZE_1024MB,
...
#else 
#if 0  //744
.cfg_ddr_training_delay_ps.write_dqs_delay[0]=0x000000aa,// 170
.cfg_ddr_training_delay_ps.write_dqs_delay[1]=0x000000aa,// 170
.cfg_ddr_training_delay_ps.write_dqs_delay[2]=0x000000b4,// 180
.cfg_ddr_training_delay_ps.write_dqs_delay[3]=0x000000b4,// 180
.cfg_ddr_training_delay_ps.write_dqs_delay[4]=0x00000076,// 118
.cfg_ddr_training_delay_ps.write_dqs_delay[5]=0x0000008a,// 138
.cfg_ddr_training_delay_ps.write_dqs_delay[6]=0x00000076,// 118
.cfg_ddr_training_delay_ps.write_dqs_delay[7]=0x00000094,// 148
.cfg_ddr_training_delay_ps.write_dq_bit_delay[0]=0x000000f3,// 243
.cfg_ddr_training_delay_ps.write_dq_bit_delay[1]=0x000000eb,// 235
.cfg_ddr_training_delay_ps.write_dq_bit_delay[2]=0x000000f0,// 240
.cfg_ddr_training_delay_ps.write_dq_bit_delay[3]=0x000000ea,// 234
.cfg_ddr_training_delay_ps.write_dq_bit_delay[4]=0x000000e8,// 232
.cfg_ddr_training_delay_ps.write_dq_bit_delay[5]=0x000000e2,// 226
.cfg_ddr_training_delay_ps.write_dq_bit_delay[6]=0x000000ed,// 237
.cfg_ddr_training_delay_ps.write_dq_bit_delay[7]=0x000000ed,// 237
.cfg_ddr_training_delay_ps.write_dq_bit_delay[8]=0x000000eb,// 235
.cfg_ddr_training_delay_ps.write_dq_bit_delay[9]=0x000000f4,// 244
.cfg_ddr_training_delay_ps.write_dq_bit_delay[10]=0x000000dd,// 221
.cfg_ddr_training_delay_ps.write_dq_bit_delay[11]=0x000000e4,// 228
.cfg_ddr_training_delay_ps.write_dq_bit_delay[12]=0x000000e6,// 230
.cfg_ddr_training_delay_ps.write_dq_bit_delay[13]=0x000000f7,// 247
.cfg_ddr_training_delay_ps.write_dq_bit_delay[14]=0x000000ea,// 234
.cfg_ddr_training_delay_ps.write_dq_bit_delay[15]=0x000000f1,// 241
.cfg_ddr_training_delay_ps.write_dq_bit_delay[16]=0x000000e6,// 230
.cfg_ddr_training_delay_ps.write_dq_bit_delay[17]=0x000000ea,// 234
.cfg_ddr_training_delay_ps.write_dq_bit_delay[18]=0x000000f2,// 242
.cfg_ddr_training_delay_ps.write_dq_bit_delay[19]=0x000000ed,// 237
.cfg_ddr_training_delay_ps.write_dq_bit_delay[20]=0x000000f2,// 242
.cfg_ddr_training_delay_ps.write_dq_bit_delay[21]=0x000000f0,// 240
.cfg_ddr_training_delay_ps.write_dq_bit_delay[22]=0x000000f2,// 242
.cfg_ddr_training_delay_ps.write_dq_bit_delay[23]=0x000000e9,// 233
.cfg_ddr_training_delay_ps.write_dq_bit_delay[24]=0x000000eb,// 235
.cfg_ddr_training_delay_ps.write_dq_bit_delay[25]=0x000000ec,// 236
.cfg_ddr_training_delay_ps.write_dq_bit_delay[26]=0x000000ee,// 238
.cfg_ddr_training_delay_ps.write_dq_bit_delay[27]=0x000000fa,// 250
.cfg_ddr_training_delay_ps.write_dq_bit_delay[28]=0x000000ed,// 237
.cfg_ddr_training_delay_ps.write_dq_bit_delay[29]=0x000000f4,// 244
.cfg_ddr_training_delay_ps.write_dq_bit_delay[30]=0x000000f0,// 240
.cfg_ddr_training_delay_ps.write_dq_bit_delay[31]=0x000000f7,// 247
.cfg_ddr_training_delay_ps.write_dq_bit_delay[32]=0x000000f3,// 243
.cfg_ddr_training_delay_ps.write_dq_bit_delay[33]=0x000000f2,// 242
.cfg_ddr_training_delay_ps.write_dq_bit_delay[34]=0x000000ef,// 239
.cfg_ddr_training_delay_ps.write_dq_bit_delay[35]=0x000000f3,// 243
...
.cfg_ddr_training_delay_ps.read_dqs_gate_delay[0]=0x000002ce,// 718
.cfg_ddr_training_delay_ps.read_dqs_gate_delay[1]=0x000002b6,// 694
.cfg_ddr_training_delay_ps.read_dqs_gate_delay[2]=0x000002cd,// 717
.cfg_ddr_training_delay_ps.read_dqs_gate_delay[3]=0x000002b3,// 691
.cfg_ddr_training_delay_ps.read_dqs_gate_delay[4]=0x000002b3,// 691
...
.cfg_ddr_training_delay_ps.read_dqs_delay[0]=0x00000083,// 131
.cfg_ddr_training_delay_ps.read_dqs_delay[1]=0x00000083,// 131
.cfg_ddr_training_delay_ps.read_dqs_delay[2]=0x00000089,// 137
.cfg_ddr_training_delay_ps.read_dqs_delay[3]=0x00000081,// 129
.cfg_ddr_training_delay_ps.read_dqs_delay[4]=0x000000f0,// 240
.cfg_ddr_training_delay_ps.read_dqs_delay[5]=0x000000f0,// 240
.cfg_ddr_training_delay_ps.read_dqs_delay[6]=0x000000f0,// 240
.cfg_ddr_training_delay_ps.read_dqs_delay[7]=0x000000f0,// 240
.cfg_ddr_training_delay_ps.read_dq_bit_delay[0]=0x00000049,// 73
.cfg_ddr_training_delay_ps.read_dq_bit_delay[1]=0x0000003f,// 63
.cfg_ddr_training_delay_ps.read_dq_bit_delay[2]=0x00000045,// 69
.cfg_ddr_training_delay_ps.read_dq_bit_delay[3]=0x00000041,// 65
.cfg_ddr_training_delay_ps.read_dq_bit_delay[4]=0x00000045,// 69
.cfg_ddr_training_delay_ps.read_dq_bit_delay[5]=0x0000003a,// 58
...
.cfg_ddr_training_delay_ps.read_dq_bit_delay[9]=0x00000050,// 80
.cfg_ddr_training_delay_ps.read_dq_bit_delay[10]=0x00000038,// 56
.cfg_ddr_training_delay_ps.read_dq_bit_delay[11]=0x0000003e,// 62
.cfg_ddr_training_delay_ps.read_dq_bit_delay[12]=0x00000042,// 66
.cfg_ddr_training_delay_ps.read_dq_bit_delay[13]=0x00000051,// 81
.cfg_ddr_training_delay_ps.read_dq_bit_delay[14]=0x00000041,// 65
.cfg_ddr_training_delay_ps.read_dq_bit_delay[15]=0x0000004a,// 74
.cfg_ddr_training_delay_ps.read_dq_bit_delay[16]=0x00000041,// 65
.cfg_ddr_training_delay_ps.read_dq_bit_delay[17]=0x00000044,// 68
.cfg_ddr_training_delay_ps.read_dq_bit_delay[18]=0x0000004a,// 74
.cfg_ddr_training_delay_ps.read_dq_bit_delay[19]=0x0000003b,// 59
.cfg_ddr_training_delay_ps.read_dq_bit_delay[20]=0x00000047,// 71
.cfg_ddr_training_delay_ps.read_dq_bit_delay[21]=0x00000042,// 66
.cfg_ddr_training_delay_ps.read_dq_bit_delay[22]=0x00000047,// 71
.cfg_ddr_training_delay_ps.read_dq_bit_delay[23]=0x0000003d,// 61
.cfg_ddr_training_delay_ps.read_dq_bit_delay[24]=0x00000042,// 66
.cfg_ddr_training_delay_ps.read_dq_bit_delay[25]=0x0000003f,// 63
.cfg_ddr_training_delay_ps.read_dq_bit_delay[26]=0x00000042,// 66
.cfg_ddr_training_delay_ps.read_dq_bit_delay[27]=0x0000004a,// 74
.cfg_ddr_training_delay_ps.read_dq_bit_delay[28]=0x0000003c,// 60
.cfg_ddr_training_delay_ps.read_dq_bit_delay[29]=0x00000046,// 70
.cfg_ddr_training_delay_ps.read_dq_bit_delay[30]=0x0000003e,// 62
.cfg_ddr_training_delay_ps.read_dq_bit_delay[31]=0x0000004b,// 75
.cfg_ddr_training_delay_ps.read_dq_bit_delay[32]=0x0000003e,// 62
.cfg_ddr_training_delay_ps.read_dq_bit_delay[33]=0x00000043,// 67
.cfg_ddr_training_delay_ps.read_dq_bit_delay[34]=0x0000003e,// 62
...
.cfg_ddr_training_delay_ps.write_dqs_delay[1]=0x000000be,// 190
.cfg_ddr_training_delay_ps.write_dqs_delay[2]=0x000000dc,// 220
.cfg_ddr_training_delay_ps.write_dqs_delay[3]=0x000000d2,// 210
.cfg_ddr_training_delay_ps.write_dqs_delay[4]=0x0000007e,// 126
.cfg_ddr_training_delay_ps.write_dqs_delay[5]=0x00000092,// 146
.cfg_ddr_training_delay_ps.write_dqs_delay[6]=0x0000007e,// 126
.cfg_ddr_training_delay_ps.write_dqs_delay[7]=0x0000009c,// 156
.cfg_ddr_training_delay_ps.write_dq_bit_delay[0]=0x00000113,// 275
.cfg_ddr_training_delay_ps.write_dq_bit_delay[1]=0x00000107,// 263
.cfg_ddr_training_delay_ps.write_dq_bit_delay[2]=0x0000010f,// 271
.cfg_ddr_training_delay_ps.write_dq_bit_delay[3]=0x00000105,// 261
.cfg_ddr_training_delay_ps.write_dq_bit_delay[4]=0x00000107,// 263
.cfg_ddr_training_delay_ps.write_dq_bit_delay[5]=0x000000fe,// 254
.cfg_ddr_training_delay_ps.write_dq_bit_delay[6]=0x0000010c,// 268
.cfg_ddr_training_delay_ps.write_dq_bit_delay[7]=0x00000112,// 274
.cfg_ddr_training_delay_ps.write_dq_bit_delay[8]=0x0000010a,// 266
.cfg_ddr_training_delay_ps.write_dq_bit_delay[9]=0x00000105,// 261
.cfg_ddr_training_delay_ps.write_dq_bit_delay[10]=0x000000e7,// 231
.cfg_ddr_training_delay_ps.write_dq_bit_delay[11]=0x000000ec,// 236
.cfg_ddr_training_delay_ps.write_dq_bit_delay[12]=0x000000f9,// 249
.cfg_ddr_training_delay_ps.write_dq_bit_delay[13]=0x00000104,// 260
...
.cfg_ddr_training_delay_ps.write_dq_bit_delay[18]=0x00000116,// 278
.cfg_ddr_training_delay_ps.write_dq_bit_delay[19]=0x00000107,// 263
.cfg_ddr_training_delay_ps.write_dq_bit_delay[20]=0x00000114,// 276
.cfg_ddr_training_delay_ps.write_dq_bit_delay[21]=0x00000112,// 274
.cfg_ddr_training_delay_ps.write_dq_bit_delay[22]=0x00000115,// 277
.cfg_ddr_training_delay_ps.write_dq_bit_delay[23]=0x0000010a,// 266
.cfg_ddr_training_delay_ps.write_dq_bit_delay[24]=0x0000010b,// 267
.cfg_ddr_training_delay_ps.write_dq_bit_delay[25]=0x00000111,// 273
.cfg_ddr_training_delay_ps.write_dq_bit_delay[26]=0x0000010f,// 271
.cfg_ddr_training_delay_ps.write_dq_bit_delay[27]=0x0000011a,// 282
.cfg_ddr_training_delay_ps.write_dq_bit_delay[28]=0x00000103,// 259
.cfg_ddr_training_delay_ps.write_dq_bit_delay[29]=0x00000115,// 277
.cfg_ddr_training_delay_ps.write_dq_bit_delay[30]=0x0000010e,// 270
.cfg_ddr_training_delay_ps.write_dq_bit_delay[31]=0x00000119,// 281
.cfg_ddr_training_delay_ps.write_dq_bit_delay[32]=0x00000108,// 264
.cfg_ddr_training_delay_ps.write_dq_bit_delay[33]=0x0000010d,// 269
.cfg_ddr_training_delay_ps.write_dq_bit_delay[34]=0x00000105,// 261
.cfg_ddr_training_delay_ps.write_dq_bit_delay[35]=0x0000010e,// 270
.cfg_ddr_training_delay_ps.write_dq_bit_delay[36]=0x00000000,// 0
.cfg_ddr_training_delay_ps.write_dq_bit_delay[37]=0x00000000,// 0
.cfg_ddr_training_delay_ps.write_dq_bit_delay[38]=0x00000000,// 0
.cfg_ddr_training_delay_ps.write_dq_bit_delay[39]=0x00000000,// 0
...
.cfg_ddr_training_delay_ps.write_dq_bit_delay[70]=0x00000000,// 0
.cfg_ddr_training_delay_ps.write_dq_bit_delay[71]=0x00000000,// 0
.cfg_ddr_training_delay_ps.read_dqs_gate_delay[0]=0x000002ca,// 714
.cfg_ddr_training_delay_ps.read_dqs_gate_delay[1]=0x000002c3,// 707
.cfg_ddr_training_delay_ps.read_dqs_gate_delay[2]=0x000002c8,// 712
.cfg_ddr_training_delay_ps.read_dqs_gate_delay[3]=0x000002bf,// 703
.cfg_ddr_training_delay_ps.read_dqs_gate_delay[4]=0x000002bf,// 703
.cfg_ddr_training_delay_ps.read_dqs_gate_delay[5]=0x00000000,// 0
.cfg_ddr_training_delay_ps.read_dqs_gate_delay[6]=0x00000000,// 0
.cfg_ddr_training_delay_ps.read_dqs_gate_delay[7]=0x00000000,// 0
.cfg_ddr_training_delay_ps.read_dqs_delay[0]=0x0000008a,// 138
.cfg_ddr_training_delay_ps.read_dqs_delay[1]=0x00000090,// 144
.cfg_ddr_training_delay_ps.read_dqs_delay[2]=0x0000008b,// 139
.cfg_ddr_training_delay_ps.read_dqs_delay[3]=0x00000081,// 129
.cfg_ddr_training_delay_ps.read_dqs_delay[4]=0x000000f0,// 240
.cfg_ddr_training_delay_ps.read_dqs_delay[5]=0x000000f0,// 240
.cfg_ddr_training_delay_ps.read_dqs_delay[6]=0x000000f0,// 240
.cfg_ddr_training_delay_ps.read_dqs_delay[7]=0x000000f0,// 240
.cfg_ddr_training_delay_ps.read_dq_bit_delay[0]=0x00000056,// 86
.cfg_ddr_training_delay_ps.read_dq_bit_delay[1]=0x00000045,// 69
.cfg_ddr_training_delay_ps.read_dq_bit_delay[2]=0x00000057,// 87
.cfg_ddr_training_delay_ps.read_dq_bit_delay[3]=0x00000042,// 66
.cfg_ddr_training_delay_ps.read_dq_bit_delay[4]=0x00000044,// 68
.cfg_ddr_training_delay_ps.read_dq_bit_delay[5]=0x00000038,// 56
.cfg_ddr_training_delay_ps.read_dq_bit_delay[6]=0x0000004c,// 76
.cfg_ddr_training_delay_ps.read_dq_bit_delay[7]=0x00000047,// 71
.cfg_ddr_training_delay_ps.read_dq_bit_delay[8]=0x00000048,// 72
.cfg_ddr_training_delay_ps.read_dq_bit_delay[9]=0x00000067,// 103
.cfg_ddr_training_delay_ps.read_dq_bit_delay[10]=0x00000037,// 55
.cfg_ddr_training_delay_ps.read_dq_bit_delay[11]=0x00000048,// 72
.cfg_ddr_training_delay_ps.read_dq_bit_delay[12]=0x00000054,// 84
.cfg_ddr_training_delay_ps.read_dq_bit_delay[13]=0x0000005d,// 93
.cfg_ddr_training_delay_ps.read_dq_bit_delay[14]=0x00000048,// 72
.cfg_ddr_training_delay_ps.read_dq_bit_delay[15]=0x0000005e,// 94
.cfg_ddr_training_delay_ps.read_dq_bit_delay[16]=0x00000046,// 70
.cfg_ddr_training_delay_ps.read_dq_bit_delay[17]=0x00000050,// 80
.cfg_ddr_training_delay_ps.read_dq_bit_delay[18]=0x0000004f,// 79
.cfg_ddr_training_delay_ps.read_dq_bit_delay[19]=0x0000003d,// 61
.cfg_ddr_training_delay_ps.read_dq_bit_delay[20]=0x0000004e,// 78
.cfg_ddr_training_delay_ps.read_dq_bit_delay[21]=0x00000043,// 67
.cfg_ddr_training_delay_ps.read_dq_bit_delay[22]=0x00000048,// 72
.cfg_ddr_training_delay_ps.read_dq_bit_delay[23]=0x00000038,// 56
.cfg_ddr_training_delay_ps.read_dq_bit_delay[24]=0x0000003d,// 61
.cfg_ddr_training_delay_ps.read_dq_bit_delay[25]=0x00000041,// 65
.cfg_ddr_training_delay_ps.read_dq_bit_delay[26]=0x00000043,// 67
.cfg_ddr_training_delay_ps.read_dq_bit_delay[27]=0x0000004b,// 75
.cfg_ddr_training_delay_ps.read_dq_bit_delay[28]=0x0000003c,// 60
.cfg_ddr_training_delay_ps.read_dq_bit_delay[29]=0x00000044,// 68
.cfg_ddr_training_delay_ps.read_dq_bit_delay[30]=0x0000003e,// 62
.cfg_ddr_training_delay_ps.read_dq_bit_delay[31]=0x00000049,// 73
.cfg_ddr_training_delay_ps.read_dq_bit_delay[32]=0x00000042,// 66
.cfg_ddr_training_delay_ps.read_dq_bit_delay[33]=0x00000040,// 64
.cfg_ddr_training_delay_ps.read_dq_bit_delay[34]=0x00000037,// 55
...
.cfg_ddr_training_delay_ps.read_dq_bit_delay[71]=0x00000000,// 0
...
#if S4_DDR3_4
	{
...
#else 
#if 0  //667
		.cfg_ddr_training_delay_ps.write_dqs_delay[0]=0x000000b4,// 180
		...
		.cfg_ddr_training_delay_ps.write_dqs_delay[6]=0x00000076,// 118
		.cfg_ddr_training_delay_ps.write_dqs_delay[7]=0x00000094,// 148
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[0]=0x000000fb,// 251
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[1]=0x000000f4,// 244
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[2]=0x000000fa,// 250
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[3]=0x000000f1,// 241
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[4]=0x000000f4,// 244
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[5]=0x000000eb,// 235
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[6]=0x000000f6,// 246
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[7]=0x000000f7,// 247
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[8]=0x000000f4,// 244
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[9]=0x000000f9,// 249
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[10]=0x000000e6,// 230
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[11]=0x000000ec,// 236
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[12]=0x000000ee,// 238
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[13]=0x000000fe,// 254
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[14]=0x000000f1,// 241
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[15]=0x000000fb,// 251
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[16]=0x000000ed,// 237
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[17]=0x000000f2,// 242
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[18]=0x000000f4,// 244
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[19]=0x000000eb,// 235
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[20]=0x000000f0,// 240
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[21]=0x000000ee,// 238
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[22]=0x000000f2,// 242
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[23]=0x000000ec,// 236
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[24]=0x000000ec,// 236
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[25]=0x000000ee,// 238
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[26]=0x000000ee,// 238
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[27]=0x000000fb,// 251
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[28]=0x000000ee,// 238
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[29]=0x000000f8,// 248
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[30]=0x000000f3,// 243
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[31]=0x000000f9,// 249
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[32]=0x000000f0,// 240
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[33]=0x000000f4,// 244
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[34]=0x000000ee,// 238
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[35]=0x000000f3,// 243
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[36]=0x00000000,// 0
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[37]=0x00000000,// 0
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[38]=0x00000000,// 0
		...
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[70]=0x00000000,// 0
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[71]=0x00000000,// 0
		.cfg_ddr_training_delay_ps.read_dqs_gate_delay[0]=0x000002ab,// 683
		.cfg_ddr_training_delay_ps.read_dqs_gate_delay[1]=0x000002bc,// 700
		.cfg_ddr_training_delay_ps.read_dqs_gate_delay[2]=0x000002c7,// 711
		.cfg_ddr_training_delay_ps.read_dqs_gate_delay[3]=0x000002ab,// 683
		.cfg_ddr_training_delay_ps.read_dqs_gate_delay[4]=0x000002ab,// 683
		.cfg_ddr_training_delay_ps.read_dqs_gate_delay[5]=0x00000000,// 0
		.cfg_ddr_training_delay_ps.read_dqs_gate_delay[6]=0x00000000,// 0
		.cfg_ddr_training_delay_ps.read_dqs_gate_delay[7]=0x00000000,// 0
		.cfg_ddr_training_delay_ps.read_dqs_delay[0]=0x00000082,// 130
		.cfg_ddr_training_delay_ps.read_dqs_delay[1]=0x0000008b,// 139
		.cfg_ddr_training_delay_ps.read_dqs_delay[2]=0x00000087,// 135
		...
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[3]=0x00000040,// 64
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[4]=0x00000042,// 66
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[5]=0x0000003b,// 59
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[6]=0x00000046,// 70
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[7]=0x00000042,// 66
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[8]=0x00000043,// 67
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[9]=0x0000005b,// 91
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[10]=0x0000003d,// 61
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[11]=0x00000044,// 68
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[12]=0x0000004a,// 74
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[13]=0x00000054,// 84
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[14]=0x0000004c,// 76
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[15]=0x00000052,// 82
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[16]=0x00000047,// 71
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[17]=0x0000004b,// 75
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[18]=0x0000004c,// 76
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[19]=0x0000003f,// 63
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[20]=0x0000004b,// 75
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[21]=0x00000041,// 65
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[22]=0x0000004a,// 74
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[23]=0x0000003c,// 60
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[24]=0x00000043,// 67
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[25]=0x0000003e,// 62
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[26]=0x00000043,// 67
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[27]=0x00000046,// 70
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[28]=0x0000003a,// 58
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[29]=0x00000042,// 66
		...
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[35]=0x00000040,// 64
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[36]=0x00000000,// 0
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[37]=0x00000000,// 0
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[38]=0x00000000,// 0
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[39]=0x00000000,// 0
		...
		.cfg_ddr_training_delay_ps.write_dqs_delay[1]=0x000000e6,// 230
		.cfg_ddr_training_delay_ps.write_dqs_delay[2]=0x000000e6,// 230
		.cfg_ddr_training_delay_ps.write_dqs_delay[3]=0x000000dc,// 220
		.cfg_ddr_training_delay_ps.write_dqs_delay[4]=0x0000007e,// 126
		.cfg_ddr_training_delay_ps.write_dqs_delay[5]=0x00000092,// 146
		.cfg_ddr_training_delay_ps.write_dqs_delay[6]=0x0000007e,// 126
		.cfg_ddr_training_delay_ps.write_dqs_delay[7]=0x0000009c,// 156
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[0]=0x00000123,// 291
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[1]=0x00000118,// 280
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[2]=0x00000123,// 291
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[3]=0x00000116,// 278
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[4]=0x0000011d,// 285
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[5]=0x0000010d,// 269
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[6]=0x00000120,// 288
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[7]=0x00000120,// 288
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[8]=0x0000011b,// 283
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[9]=0x0000012c,// 300
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[10]=0x00000109,// 265
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[11]=0x00000112,// 274
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[12]=0x0000011c,// 284
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[13]=0x00000135,// 309
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[14]=0x00000120,// 288
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[15]=0x0000012f,// 303
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[16]=0x0000011a,// 282
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[17]=0x00000120,// 288
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[18]=0x00000120,// 288
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[19]=0x00000110,// 272
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[20]=0x00000118,// 280
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[21]=0x00000117,// 279
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[22]=0x0000011f,// 287
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[23]=0x00000114,// 276
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[24]=0x00000116,// 278
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[25]=0x00000117,// 279
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[26]=0x00000117,// 279
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[27]=0x00000125,// 293
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[28]=0x00000110,// 272
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[29]=0x0000011e,// 286
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[30]=0x00000116,// 278
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[31]=0x00000123,// 291
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[32]=0x00000114,// 276
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[33]=0x00000119,// 281
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[34]=0x00000112,// 274
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[35]=0x00000119,// 281
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[36]=0x00000000,// 0
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[37]=0x00000000,// 0
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[38]=0x00000000,// 0
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[39]=0x00000000,// 0
		...
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[70]=0x00000000,// 0
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[71]=0x00000000,// 0
		.cfg_ddr_training_delay_ps.read_dqs_gate_delay[0]=0x000002dd,// 733
		.cfg_ddr_training_delay_ps.read_dqs_gate_delay[1]=0x000002c7,// 711
		.cfg_ddr_training_delay_ps.read_dqs_gate_delay[2]=0x000002cf,// 719
		.cfg_ddr_training_delay_ps.read_dqs_gate_delay[3]=0x000002cd,// 717
		.cfg_ddr_training_delay_ps.read_dqs_gate_delay[4]=0x000002cd,// 717
		.cfg_ddr_training_delay_ps.read_dqs_gate_delay[5]=0x00000000,// 0
		.cfg_ddr_training_delay_ps.read_dqs_gate_delay[6]=0x00000000,// 0
		.cfg_ddr_training_delay_ps.read_dqs_gate_delay[7]=0x00000000,// 0
		.cfg_ddr_training_delay_ps.read_dqs_delay[0]=0x00000084,// 132
		.cfg_ddr_training_delay_ps.read_dqs_delay[1]=0x00000093,// 147
		.cfg_ddr_training_delay_ps.read_dqs_delay[2]=0x0000008a,// 138
		.cfg_ddr_training_delay_ps.read_dqs_delay[3]=0x0000007f,// 127
		.cfg_ddr_training_delay_ps.read_dqs_delay[4]=0x000000f0,// 240
		.cfg_ddr_training_delay_ps.read_dqs_delay[5]=0x000000f0,// 240
		.cfg_ddr_training_delay_ps.read_dqs_delay[6]=0x000000f0,// 240
		.cfg_ddr_training_delay_ps.read_dqs_delay[7]=0x000000f0,// 240
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[0]=0x00000057,// 87
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[1]=0x00000040,// 64
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[2]=0x00000056,// 86
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[3]=0x00000042,// 66
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[4]=0x00000047,// 71
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[5]=0x00000039,// 57
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[6]=0x0000004c,// 76
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[7]=0x00000047,// 71
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[8]=0x00000048,// 72
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[9]=0x0000006b,// 107
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[10]=0x00000038,// 56
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[11]=0x00000044,// 68
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[12]=0x0000004f,// 79
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[13]=0x00000063,// 99
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[14]=0x00000052,// 82
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[15]=0x0000005b,// 91
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[16]=0x00000049,// 73
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[17]=0x00000051,// 81
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[18]=0x0000004c,// 76
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[19]=0x0000003c,// 60
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[20]=0x0000004d,// 77
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[21]=0x00000040,// 64
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[22]=0x0000004b,// 75
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[23]=0x00000034,// 52
		...
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[31]=0x0000004e,// 78
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[32]=0x00000045,// 69
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[33]=0x00000045,// 69
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[34]=0x00000037,// 55
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[35]=0x00000042,// 66
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[36]=0x00000000,// 0
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[37]=0x00000000,// 0
