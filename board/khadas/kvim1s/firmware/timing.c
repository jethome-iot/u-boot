...
ddr_set_ps0_only_t __ddr_setting[] __attribute__ ((section(".ddr_param"))) = {
#if S4_DDR3
	{
...
#if 1
		.cfg_ddr_training_delay_ps.write_dqs_delay[0] = 0xb4,// 180
		.cfg_ddr_training_delay_ps.write_dqs_delay[1] = 0xb4,// 180
		.cfg_ddr_training_delay_ps.write_dqs_delay[2] = 0xb4,// 180
		.cfg_ddr_training_delay_ps.write_dqs_delay[3] = 0xaa,// 170
		.cfg_ddr_training_delay_ps.write_dqs_delay[4] = 0x7e,// 126
		.cfg_ddr_training_delay_ps.write_dqs_delay[5] = 0x92,// 146
		.cfg_ddr_training_delay_ps.write_dqs_delay[6] = 0x7e,// 126
		.cfg_ddr_training_delay_ps.write_dqs_delay[7] = 0x9c,// 156
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[0] = 0xfb,// 251
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[1] = 0xed,// 237
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[2] = 0xfe,// 254
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[3] = 0xf8,// 248
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[4] = 0xf9,// 249
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[5] = 0xea,// 234
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[6] = 0xfa,// 250
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[7] = 0xf8,// 248
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[8] = 0xf6,// 246
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[9] = 0x101,// 257
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[10] = 0xeb,// 235
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[11] = 0xf7,// 247
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[12] = 0xf2,// 242
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[13] = 0x102,// 258
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[14] = 0xf7,// 247
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[15] = 0x103,// 259
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[16] = 0xf3,// 243
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[17] = 0xf7,// 247
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[18] = 0xfa,// 250
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[19] = 0xe5,// 229
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[20] = 0xf4,// 244
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[21] = 0xea,// 234
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[22] = 0xf9,// 249
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[23] = 0xeb,// 235
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[24] = 0xec,// 236
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[25] = 0xf5,// 245
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[26] = 0xef,// 239
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[27] = 0xfa,// 250
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[28] = 0xe9,// 233
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[29] = 0xf1,// 241
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[30] = 0xec,// 236
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[31] = 0xf5,// 245
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[32] = 0xec,// 236
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[33] = 0xef,// 239
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[34] = 0xe8,// 232
		.cfg_ddr_training_delay_ps.write_dq_bit_delay[35] = 0xf3,// 243
		...
		.cfg_ddr_training_delay_ps.read_dqs_gate_delay[0] = 0x2ae,// 686
		.cfg_ddr_training_delay_ps.read_dqs_gate_delay[1] = 0x2a1,// 673
		.cfg_ddr_training_delay_ps.read_dqs_gate_delay[2] = 0x2b2,// 690
		.cfg_ddr_training_delay_ps.read_dqs_gate_delay[3] = 0x2a1,// 673
		.cfg_ddr_training_delay_ps.read_dqs_gate_delay[4] = 0x2a1,// 673
		...
		.cfg_ddr_training_delay_ps.read_dqs_delay[0] = 0x85,// 133
		.cfg_ddr_training_delay_ps.read_dqs_delay[1] = 0x85,// 133
		.cfg_ddr_training_delay_ps.read_dqs_delay[2] = 0x90,// 144
		.cfg_ddr_training_delay_ps.read_dqs_delay[3] = 0x82,// 130
		.cfg_ddr_training_delay_ps.read_dqs_delay[4] = 0xf0,// 240
		.cfg_ddr_training_delay_ps.read_dqs_delay[5] = 0xf0,// 240
		.cfg_ddr_training_delay_ps.read_dqs_delay[6] = 0xf0,// 240
		.cfg_ddr_training_delay_ps.read_dqs_delay[7] = 0xf0,// 240
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[0] = 0x4d,// 77
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[1] = 0x3f,// 63
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[2] = 0x4a,// 74
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[3] = 0x4e,// 78
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[4] = 0x50,// 80
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[5] = 0x3d,// 61
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[6] = 0x51,// 81
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[7] = 0x4a,// 74
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[8] = 0x49,// 73
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[9] = 0x4e,// 78
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[10] = 0x3d,// 61
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[11] = 0x49,// 73
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[12] = 0x43,// 67
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[13] = 0x5b,// 91
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[14] = 0x46,// 70
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[15] = 0x52,// 82
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[16] = 0x3f,// 63
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[17] = 0x49,// 73
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[18] = 0x54,// 84
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[19] = 0x3d,// 61
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[20] = 0x4b,// 75
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[21] = 0x46,// 70
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[22] = 0x5a,// 90
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[23] = 0x48,// 72
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[24] = 0x50,// 80
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[25] = 0x48,// 72
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[26] = 0x4b,// 75
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[27] = 0x4e,// 78
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[28] = 0x38,// 56
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[29] = 0x44,// 68
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[30] = 0x40,// 64
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[31] = 0x49,// 73
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[32] = 0x3d,// 61
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[33] = 0x46,// 70
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[34] = 0x3a,// 58
		.cfg_ddr_training_delay_ps.read_dq_bit_delay[35] = 0x42,// 66
	...
	{
		//timing_config,4layer 2pcs ddr4 rank0.
		.cfg_board_common_setting.timming_magic = 0,
		.cfg_board_common_setting.timming_max_valid_configs =
			sizeof(__ddr_setting[0]) / sizeof(ddr_set_ps0_only_t),
		.cfg_board_common_setting.timming_struct_version = 0,
